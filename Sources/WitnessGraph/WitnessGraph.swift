...
/**
 ...
 - Throws: `WitnessGraphProverError` child classes
...
//    }
    ...
    // Call the WitnessGraph C++ library function to perform the Groth16 proof
    ...
    guard let msg = statusPointer.pointee.error_msg else {
        throw WitnessGraphError(message: "Unknown error")
    }
    let msgString = String(cString: msg)

    throw WitnessGraphError(message: msgString)
}


public protocol WitnessGraphErrorProtocol : CustomNSError {
    var message: String { get }
}

public extension WitnessGraphError {
    var errorUserInfo: [String : Any] {
        return ["message": message]
    }
}

public class WitnessGraphError : WitnessGraphErrorProtocol {
